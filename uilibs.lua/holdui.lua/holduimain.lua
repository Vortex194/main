...
function Library:Window()
    ...
    Shade.ImageColor3 = Color3.fromRGB(20, 20, 20)
    ...
    Discord.Text = "discord.gg/roblox"
    ...
    NotificationHolderCorner.CornerRadius = UDim.new(0, 6)
        ...
        if input.KeyCode == Library.settings["toggleKey"] then
            if opened == true then
                if MainFrame.Parent ~= nil then
                    ...
                    local maintween = MainFrame:TweenSize(UDim2.new(0, 0, -0.35, 395), Enum.EasingDirection.InOut, Enum.EasingStyle.Linear, 0.5, true)
                    opened = false
                    wait(0.5)
                end
            elseif opened == false then
                if MainFrame.Parent ~= nil then
                    local maintween = MainFrame:TweenSize(UDim2.new(0, 575, 0, 402), Enum.EasingDirection.Out, Enum.EasingStyle.Bounce, 0.55, true)
                    opened = true
                    wait(0.5)
    ...
    function Library:Prompt(tit, desc, answers)
        ...
        PromptStroke.Color = Color3.fromRGB(42, 42, 42)
        ...
        PromptTitle.TextColor3 = Color3.fromRGB(109, 133, 255)
        PromptTitle.TextSize = 12.000

        Yes.Name = "Yes"
        Yes.Parent = Prompt
        Yes.BackgroundColor3 = Color3.fromRGB(26, 26, 26)
        ...
        YesStroke.Color = Color3.fromRGB(100, 119, 231)
        ...
        Cancel.BackgroundColor3 = Color3.fromRGB(26, 26, 26)
        ...
        CancelStroke.Color = Color3.fromRGB(100, 119, 231)
        ...
        PromptDescription.TextColor3 = Color3.fromRGB(236, 236, 236)
        PromptDescription.TextSize = 12.000
        ...
        PromptCorner.CornerRadius = UDim.new(0, 3)
        ...
        Cancel.MouseEnter:Connect(function()
            Tween(Cancel, 0.1, {BackgroundColor3 = Color3.fromRGB(100, 119, 231)})
        end)
        Cancel.MouseLeave:Connect(function()
            Tween(Cancel, 0.1, {BackgroundColor3 = Color3.fromRGB(26, 26, 26)})
        end)
        Yes.MouseEnter:Connect(function()
            Tween(Yes, 0.1, {BackgroundColor3 = Color3.fromRGB(100, 119, 231)})
        end)
        Yes.MouseLeave:Connect(function()
            Tween(Yes, 0.1, {BackgroundColor3 = Color3.fromRGB(26, 26, 26)})
        end)
    ...
    function Window:Tab(pagename)
        ...
        TabTrigger.Font = Enum.Font.SourceSans
        TabTrigger.Text = ""
        ...
        function OuterContainer:Section(secname)
            ...
            SectionText.TextColor3 = Color3.fromRGB(225, 225, 225)
            ...
            function Container:Toggle(togname, toggled, callback)
                ...
                ToggleText.TextColor3 = Color3.fromRGB(235, 235, 235)
                ...
                ToggleOut.BackgroundColor3 = Color3.fromRGB(195, 195, 195)
                ...
                ToggleTrigger.MouseButton1Click:Connect(function()
                    ...
                    if not toggled then
                        ...
                        Tween(ToggleOut, 0.2, {BackgroundColor3 = Color3.fromRGB(195, 195, 195)})
                    end
                end)
            ...
            function Container:Slider(sldname, min, max, start, callback)
                ...
                SliderText.TextColor3 = Color3.fromRGB(235, 235, 235)
                ...
                SliderTrigger.MouseButton1Down:Connect(function()
                    Value = math.floor((((tonumber(max) - tonumber(min)) / 356) * SliderIn.AbsoluteSize.X) + tonumber(min)) or 0
                    callback(Value)
                    SliderIn.Size = UDim2.new(0, math.clamp(mouse.X - SliderIn.AbsolutePosition.X, 0, 356), 0, 32)
                    moveconnection = mouse.Move:Connect(function()
                        SliderValue.Text = Value
                        Value = math.floor((((tonumber(max) - tonumber(min)) / 356) * SliderIn.AbsoluteSize.X) + tonumber(min))
                        callback(Value)
                        SliderIn.Size = UDim2.new(0, math.clamp(mouse.X - SliderIn.AbsolutePosition.X, 0, 356), 0, 32)
                    end)
            ...
            function Container:Textbox(texname, placeholder, callback)
                ...
                TextboxTrigger.ImageColor3 = Color3.fromRGB(225, 225, 225)
                ...
                TextboxTyper.BackgroundColor3 = Color3.fromRGB(31, 31, 31)
                ...
                TextboxTyper.FocusLost:Connect(function()
                    ...
                    --TextboxValue.Text = texname.." - "..TextboxTyper.Text
                    --TextboxTyper.Text = ""
                    --Tween(Textbox, 0.3, {Size = UDim2.new(0, 373, 0, 42)})
                    --opened = not opened
                end)
            ...
            function Container:Dropdown(dropname, list, callback)
                ...
                Dropdown.Size = UDim2.new(0, 373, 0, 42) --93
                ...
                DropdownText.TextColor3 = Color3.fromRGB(235, 235, 235)
                ...
                DropdownValue.BackgroundColor3 = Color3.fromRGB(31, 31, 31)
                ...
                DropdownList.Size = UDim2.new(0, 356, 0, 0) --40
                ...
                DropdownValue.Focused:Connect(function()
                    if DidChoose then return end
                    repeat task.wait() until IsFocused ~= nil
                ...
                for i, v in next, list do
                    ...
                    Item.MouseEnter:Connect(function()
                        Tween(Item, 0.1, {BackgroundColor3 = Color3.fromRGB(30, 30, 30)})
                    end)
                    Item.MouseLeave:Connect(function()
                        Tween(Item, 0.1, {BackgroundColor3 = Color3.fromRGB(31, 31, 31)})
                    end)
            ...
            function Container:Information(title, desc)
                ...
                Information.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
                ...
                InformationTitle.Font = Enum.Font.Gotham
                InformationTitle.Text = title
                InformationTitle.TextColor3 = Color3.fromRGB(229, 229, 229)
                ...
                InformationDesc.TextColor3 = Color3.fromRGB(175, 175, 175)
            ...
            function Container:MultiSelect(mname, list, callback)
                ...
                Multiselect.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
                Multiselect.ClipsDescendants = true
                Multiselect.Position = UDim2.new(0.007500013, 0, 0.658627093, 0)
                Multiselect.Size = UDim2.new(0, 373, 0, 45) -- 93
            
                MultiselectCorner.CornerRadius = UDim.new(0, 4)
                ...
                MultiselectText.Font = Enum.Font.GothamMedium
                MultiselectText.Text = mname
                MultiselectText.TextColor3 = Color3.fromRGB(235, 235, 235)
                ...
                for i, v in next, list do
                    ...
                    MItemText.Font = Enum.Font.Gotham
                    MItemText.Text = name
                    ...
                    MItemTrigger.Font = Enum.Font.SourceSans
                    MItemTrigger.Text = ""
