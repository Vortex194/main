...
local Window = library:Window("TEST UI")

local Tabs = {
    TESTV1 = Window:Tab("TEST W1"),
    TESTV2 = Window:Tab("TEST W2"),
    TESTV3 = Window:Tab("TEST W3"),
    TESTV4 = Window:Tab("TEST W4"),
    TESTV5 = Window:Tab("TEST W5"),
    TESTV6 = Window:Tab("TEST W6")
}

local Sections = {
    AutofarmSettings = Tabs.TESTV1:Section("TEST SEC1"),
    AutofarmMisc = Tabs.TESTV2:Section("TEST SEC2"),
    LocalCharacter = Tabs.TESTV3:Section("TEST SEC3"),
    LocalCheats = Tabs.TESTV4:Section("TEST SEC4"),
    CombatSettings = Tabs.TESTV5:Section("TEST SEC5"),
    MiscRandom = Tabs.TESTV6:Section("TEST SEC6"),
}
